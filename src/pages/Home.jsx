  ...
  return (
    <>
      <main className="container">
        <div className="relative bg-[url('public/images/herobg.jpg')] rounded-xl bg-no-repeat bg-cover">
          <section className="flex justify-between md:flex-row flex-col">
            ...
            <div className=" md:w-1/2 flex pt-10  md:pt-16 md:left-60 relative justify-center items-center ">
              <img
